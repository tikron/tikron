...
<c:url var="displayHomepageUrl" value="/displayHomepage.html"><c:param name="lang" value="de"></c:param></c:url>
<div id="content">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-xs-12">
			<article>
				<header><h1><spring:message code="displayUnsupportedLanguage.headline"/></h1></header>
				<p><spring:message code="displayUnsupportedLanguage.info"/></p>
				<c:if test="${not empty messageKey}">
				<br />
				<p><spring:message code="${messageKey}" arguments="${messageParam}"/></p>
				</c:if>
				<br />
				<a href="${displayHomepageUrl}"><spring:message code="link.homepage"/></a>
			</article>
		</div>
	</div>
</div>
